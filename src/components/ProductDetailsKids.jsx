...
function ProductDetailsKids() {
  ...
  const product = context.products.find((item) => item._id === params.id);
    ...
    <div>
      <div className='flex items-center px-64 py-16'>
        <div className='flex items-center'>
          <div>
            <img className='py-2 h-32 w-48' src={product.img} alt="" />
            <img className='py-2 h-32 w-48' src={product.img} alt="" />
            <img className='py-2 h-32 w-48' src={product.img} alt="" />
          </div>
        ...
        <div>
          ...
          <div className='text-lg mb-316 px-8 py-8'>
            {product.description}
          </div>
          <div>
            ...
            <button
              ...
              className='px-6 py-2 ml-32 mt-2 border-2 border-black cursor-pointer rounded-xl shadow-2xl hover:bg-green-500 hover:text-white hover:scale-95'
            >
              Add to cart
            </button>
          </div>
